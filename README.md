...
## Overview
This website is for the yacht, Shaula. It will enable voyages to be logged, documents to be uploaded and manuals to be uploaded. The log, ,documents and manuals will be editable. Editing the site will be restricted to password protected users. This readme document describes the organization of the site.
